%train_cplace_ftc examines sound data at times when formant closures are labeled
%in order to create a gaussian mixture model of probable closure characteristics
%
% Inputs: trainFilePrefixes - the prefixes of WAV and TextGrid file pairs
%         to be used for training
%
% Outputs: labDist - a GMM with values corresponding to measured labial closure features
%          denDist - a GMM with values corresponding to measured dental closure features
%          alvDist - a GMM with values corresponding to measured alvelor closure features
%          palDist - a GMM with values corresponding to measured palatal closure features
%          velDist - a GMM with values corresponding to measured velar closure features
%          
...
function [labDist, denDist, alvDist, palDist, velDist] = train_cplace_ftc( trainFilePrefixes )
...
for iFile = 1:numel(trainFilePrefixes)
    ...
    V=[V1 V2];
    [lab,den,alv,pal,vel] = ...
        readtextgridftc([trainFilePrefixes{iFile} '.TextGrid']);
