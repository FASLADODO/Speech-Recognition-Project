function [labels, start, stop,file] = func_readTextgrid(filename)
...
% Notes:  Functions s=eeks out the "xmin", "xmax", and "text" labels within
% a textgrid file.
%
% Author: Yen-Liang Shue, Speech Processing and Auditory Perception Laboratory, UCLA
% Copyright UCLA SPAPL 2009

POINT_BUFFER = 0.000; % 25 ms buffer on either side of the point
